...
def _build_styles():
    ...
    title = ParagraphStyle(
        "Title", parent=styles["Title"], fontName=base_bold, fontSize=24,
        leading=30, alignment=TA_CENTER, textColor=colors.HexColor("#0F172A"), spaceAfter=16,
    )
    subtitle = ParagraphStyle(
        "Subtitle", parent=styles["Normal"], fontName=base_font, fontSize=12,
        leading=16, alignment=TA_CENTER, textColor=colors.HexColor("#334155"), spaceAfter=18,
    )
    h1 = ParagraphStyle(
        "H1", parent=styles["Heading1"], fontName=base_bold, fontSize=16,
        leading=20, textColor=colors.HexColor("#0F172A"), spaceBefore=10, spaceAfter=8,
    )
    h2 = ParagraphStyle(
        "H2", parent=styles["Heading2"], fontName=base_bold, fontSize=13,
        leading=16, textColor=colors.HexColor("#0F172A"), spaceBefore=8, spaceAfter=6,
    )
    body = ParagraphStyle(
        "Body", parent=styles["BodyText"], fontName=base_font, fontSize=10.5,
        leading=14, textColor=colors.HexColor("#111827"), alignment=TA_LEFT, spaceAfter=6,
    )
    small = ParagraphStyle(
        "Small", parent=styles["BodyText"], fontName=base_font, fontSize=9,
        leading=12, textColor=colors.HexColor("#475569"), spaceAfter=4,
    )
    bullet = ParagraphStyle(
        "Bullet", parent=body, leftIndent=14, bulletIndent=6, spaceAfter=3,
    )
    return {
        "title": title, "subtitle": subtitle, "h1": h1, "h2": h2,
        "body": body, "small": small, "bullet": bullet,
        "base_font": base_font, "base_bold": base_bold,
    }
...
def generate_audit_pdf(
    ...
    # Mobile Friendliness – FIXED SECTION
    ...
    _bullets(story, [str(x) for x in _ensure_list(_safe_get(audit_data, "mobile.usability_problems", []))], styles)
