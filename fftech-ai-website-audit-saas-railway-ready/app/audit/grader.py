...
def run_audit(url: str):
    ...
    categories = {
        "A. Executive Summary": {"score": seo_res['score'], "metrics": {"1_Health": seo_res['score'], "6_Priority": "Technical SEO"}, "color": "#4F46E5"},
        "D. On-Page SEO": seo_res,
        "E. Performance": perf_res,
        "H. Broken Links Intelligence": {"score": 100, "metrics": {"168_Total_Broken": 0}, "color": "#F59E0B"}
    }
