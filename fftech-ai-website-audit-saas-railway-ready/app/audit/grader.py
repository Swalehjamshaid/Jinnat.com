...
def run_audit(url: str):
    """
    Orchestrates the full audit suite.
    Combines SEO, Performance, PSI, broken links, and AI recommendations.
    """
    ...
    # ──────────────────────────────
    # Run SEO and Performance Audits
    # ──────────────────────────────
    ...
    # ──────────────────────────────
    # Categories for detailed report
    # ──────────────────────────────
    categories = {
        "A. Executive Summary": {
    ...
    # ──────────────────────────────
    # PSI / Core Web Vitals adjustments
    # ──────────────────────────────
    ...
    ai_recs = generate_ai_recommendations(
        seo_metrics=seo_res.get('metrics', {}),
        performance_metrics=categories["E. Performance"]["metrics"]
    )
    categories["I. AI Recommendations"] = {
        "score": 100 if len(ai_recs) == 0 else max(50, 100 - len(ai_recs) * 5),
