def run_seo_audit(crawl_obj):
    ...
    penalties += metrics["41_Missing_Titles"] * 12          # Missing title = serious
    penalties += metrics["43_Missing_Meta_Descriptions"] * 10
    penalties += metrics["23_HTTP_4xx"] * 8                 # Client errors hurt crawl
    ...
    return {
        "score": round(score, 2),
        "metrics": metrics,
        "color": "#4F46E5"   # kept same as original
    }
