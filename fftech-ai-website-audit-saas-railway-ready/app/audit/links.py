...
# Limit concurrent links to 10 to avoid hanging
...
async def analyze_links_async(html_input, base_url, progress_callback=None):
    ...
    for a in soup.find_all("a", href=True):
        ...
        if not href or any(href.startswith(s) for s in ["tel:", "mailto:", "javascript:"]): continue
    ...
    # Check first 10 internal links for broken status
    broken_count = 0
